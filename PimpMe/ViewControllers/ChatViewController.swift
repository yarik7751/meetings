...
class ChatViewController: JSQMessagesViewController {
  ...
  private func observeMessages() {
    ...
    guard let messageData = snapshot.value as? NSDictionary  else {
      self.finishSendingMessage()
      return }

    self.addMessage(with: "\(messageData["senderId"] as! Int)", name: "\(messageData["date"] as! Int)", text: messageData["text"] as! String)
