...
public class DeletePhotoService extends IntentService {
    ...
    public static final String ACTION = "com.elatesoftware.meetings.ui.service.DeletePhotoService";
    ...
    protected void onHandleIntent(Intent intent) {
        String response = Api.deletePhoto(CustomSharedPreference.getToken(this), intent.getLongExtra(PHOTO_ID, -1));
